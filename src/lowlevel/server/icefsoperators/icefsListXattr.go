 ...
 * @LastEditTime: 2023-03-30 04:28:44
...
func (s *IcefsServer) DoIcefsListXattr(ctx context.Context, req *pb.IcefsListXattrReq) (*pb.IcefsListXattrRes, error) {
	...
	size, err = syscall.Listxattr(procName, res.Value)
	if err != nil {
